...
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/EquationsOfStateOfSolids.jl"
```
...
our [GitHub repository](https://github.com/MineralsCloud/EquationsOfStateOfSolids.jl)
for new releases.
Once we release a new version, you can update `EquationsOfStateOfSolids` by typing
